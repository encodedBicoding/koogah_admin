function DashboardCustomers() {
  return (
    <main className="py-6 px-5">
      ...
      <div class="grid gap-4 lg:flex bg-white p-6 md:flex">
        <select class="border p-3 focus:outline-none focus:shadow-outline py-3 px-2 lg:w-4/12 md:w-4/12 w-full" aria-label="Default select example">
